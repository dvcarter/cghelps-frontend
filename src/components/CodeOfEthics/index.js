...
const CodeOfEthics = () => {
    return (
        <div style={divStyle}>
            ...
            <br />
            <br />
            <div style={titleStyle}> Preamble</div>
            <br />
            <ul><li>
            ...
            <br />
            <br />
            <div style={titleStyle}> The Code of Ethics</div>
            <ol>
                ...
                <br />
                    <ol type="A">   
                        <li> <strong>  Beneficence:  the duty to promote the welfare of, and prevent harm to, all individuals served.</strong>
                        <br />
...
<div style={authorStyle}>Reviewed By: Kyle Glasgow, Director of Mission Impact & Data Analysis
<br />
