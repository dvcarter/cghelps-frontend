        ...
        <div className={styles.divStyle}>
          <form
            ...
            <div className={ styles.formGroup3 }>
              <label>Message:</label>
              <textarea className={styles.messageContact} value={this.state.message} name="message" placeholder="Your message" onChange={this.handleChange.bind(this, 'message')} required  />
            </div>
