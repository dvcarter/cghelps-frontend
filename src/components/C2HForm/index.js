...
You will come away with a better understanding of how critical Common Ground is to our community. We are not asking for contributions, but we will follow up with you a few days after the presentation to gather comments and feedback. It will easily be the best hour of your day. The address of our tour is below. After arriving at the Resource and Crisis center, you will have to sign in at the front desk and the Welcoming Specialist will direct you to the appropriate room. 
            ...
            <div className={styles.formProper}>
                ...
                <div>
                    ...
                    <div>
                        <input
                            name="August 15th, 6-7pm"
                            id="volunteerTimes"
                            component="input"
                            type="checkbox"
                            value="yes"
                        />  
                        <label htmlFor="volunteerTimes"> Wednesday, August 15<sup>th</sup> 6pm-7pm</label>
                    </div>
                    <div>
                        <input
                            name="September 19th, 6-7pm"
                            id="volunteerTimes"
                            component="input"
                            type="checkbox"
                            value="yes"
                        />  
                        <label htmlFor="volunteerTimes"> Wednesday, September 19<sup>th</sup> 6pm-7pm</label>
                    </div>
                    <div>
                        <input
                            name="October 17th, 6-7pm"
                            id="volunteerTimes"
                            component="input"
                            type="checkbox"
                            value="yes"
                        />  
                        <label htmlFor="volunteerTimes"> Wednesday, October 17<sup>th</sup> 6pm-7pm</label>
                    </div> 
                </div>
                <div>
                </div>
